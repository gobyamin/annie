...
,
  ...
  'f-mom':         { kr:'엄마', en:'mum', tag:'family', mine:'fam-eomma',
                     ask:'You are talking to your mother. What do you call her?' },
  'f-dad':         { kr:'아빠', en:'dad', tag:'family', mine:'fam-appa',
                     ask:'You are talking to your father. What do you call him?' },
  'f-oppa':        { kr:'오빠', en:'older brother (she says)', tag:'family', mine:'fam-oppa',
                     ask:'You are a woman. Your older brother walks in. Call him.' },
  'f-nuna':        { kr:'누나', en:'older sister (he says)', tag:'family', mine:'fam-nuna',
                     ask:'You are a man. Your older sister walks in. Call her.' },
  'f-eonni':       { kr:'언니', en:'older sister (she says)', tag:'family', mine:'fam-eonni',
                     ask:'You are a woman. Your older sister walks in. Call her.' },
  'f-dongsaeng':   { kr:'동생', en:'younger sibling', tag:'family', mine:'fam-dongsaeng',
                     ask:'You are talking about your younger brother or sister. What is the word?' },
  ...
  /* 마리 1회차 뒤 추가. 소리는 아직 없다 — 녹음하면 mine 을 채운다 */
  'bye-going-f':   { kr:'안녕히 가세요', en:'bye (they leave, polite)', tag:'greeting',
                     note:'The pair to 안녕히 계세요. One stays, one goes.',
                     ask:'Someone is leaving. Say goodbye politely.' },
  'n-moonyujin':   { kr:'문유진', en:'Moon Yujin — your Korean name', tag:'name',
                     note:'문 is literature. 유진 was picked from your birth chart.' },
  'fd-bulgogi':    { kr:'불고기', en:'bulgogi', tag:'food',
                     note:'You already cook this one.' },
  'fd-kimchijjigae': { kr:'김치찌개', en:'kimchi stew', tag:'food',
                     note:'You already cook this one too.' },
  'fd-ramyeon':    { kr:'라면', en:'ramyeon', tag:'food',
                     note:'Your words: it has your heart.' },
  'fd-tteokbokki': { kr:'떡볶이', en:'tteokbokki', tag:'food' }
};
